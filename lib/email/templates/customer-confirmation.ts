...
interface CustomerConfirmationData {
  ...
  // wanneer er (nog) geen prijs bekend is voor deze maat/afwerking. Blijft,
  // anders dan de interne meldingsmail (configuration-confirmation.ts), WEL
  // gewoon zichtbaar in deze klantmail — 15-9-2026, Christiaan had het
  // verzoek "geen prijzen in de bevestigingsmails" (14-9-2026) bedoeld voor
  // de interne mail, niet voor deze klantbevestiging; hier weer hersteld.
